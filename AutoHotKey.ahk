...
WinWaitActive 000236950459 - RSA SecurID Token,,
Send, 3839 {Enter}
Sleep, 500
Send {tab} {Space}
Sleep, 500
;PostMessage, 0x112, 0xF060,,, 000236950459 - RSA SecurID Token,   ; 0x112 = WM_SYSCOMMAND, 0xF060 = SC_CLOSE
;WinClose 000236950459 - RSA SecurID Token,,1
Sleep, 500
Run, C:\Program Files (x86)\Cisco\Cisco AnyConnect Secure Mobility Client\vpnui.exe
Sleep, 500
;Send {tab} {tab} {Space}
...
Sleep, 1000
Send {Tab} 
Send, WebEx below; MeetingPlace ID: 1326238 
Send {Tab} {Tab} {Tab} {Tab} {Tab} {Tab} 
Send, https://sutherlandmc.webex.com/meet/liafrank {Enter}
return
;
